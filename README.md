...
> 💡 **提示**: 本插件特别适合让各种廉价/本地模型使用。如果不在意成本，推荐使用 MCP 版本：https://github.com/kawayiYokami/moegirl-mcp

> 💡 **提示**: 本插件特别适合让各种廉价/本地模型使用，作为前置搜索增强知识。如果不在乎成本，可以考虑使用 MCP 版本: [moegirl-mcp](https://github.com/kawayiYokami/moegirl-mcp)
